...
import com.konexios.acn.client.model.DeviceActionModel;
import com.konexios.acn.client.model.DeviceActionTypeModel;
...
public class DeviceActionApi extends ApiAbstract {
	...
	DeviceActionApi(ApiConfig apiConfig, MqttHttpChannel mqttHttpChannel) {
